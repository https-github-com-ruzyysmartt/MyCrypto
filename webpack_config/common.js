  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      metaCsp: IS_DEVELOPMENT
        ? ''
        : "default-src 'none'; script-src 'self' 'unsafe-eval'; worker-src 'self' blob:; child-src 'self'; style-src 'self' 'unsafe-inline'; manifest-src 'self'; font-src 'self'; img-src 'self' data: https://cdn.mycryptoapi.com/; connect-src *; frame-src 'self' https://connect.trezor.io;"
    }),
